...
public class PagingExtagram {
	...
	public PagingExtagram() { }
	
	//총 게시글 수를 입력하는 생성자
	public PagingExtagram(int totalCount) {
	...
	public PagingExtagram(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingExtagram(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingExtagram(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0)	setListCount(16);	//화면에 보여질 게시글 수를 기본 12개로 설정한다
