...
public class PagingUserHistory2 {
private int curPage;	//현재 페이지 번호
	...
	public PagingUserHistory2() { }
	
	//총 게시글 수를 입력하는 생성자
	public PagingUserHistory2(int totalCount) {
	...
	public PagingUserHistory2(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingUserHistory2(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingUserHistory2(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
