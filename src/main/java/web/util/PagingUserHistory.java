...
public class PagingUserHistory {
private int curPage;	//현재 페이지 번호
	...
	public PagingUserHistory() { }
	
	//총 게시글 수를 입력하는 생성자
	public PagingUserHistory(int totalCount) {
	...
	public PagingUserHistory(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingUserHistory(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingUserHistory(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0)	setListCount(5);	//화면에 보여질 게시글 수를 기본 10개로 설정한다
	...
	public String toString() {
		return "PagingUser [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
