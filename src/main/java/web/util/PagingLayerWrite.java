...
public class PagingLayerWrite {
	...
	public PagingLayerWrite() { }
	
	//총 게시글 수를 입력하는 생성자
	public PagingLayerWrite(int totalCount) {
	...
	public PagingLayerWrite(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingLayerWrite(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public PagingLayerWrite(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0)	setListCount(12);	//화면에 보여질 게시글 수를 기본 10개로 설정한다
